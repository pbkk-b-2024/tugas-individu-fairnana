    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="{{ route('home') }}" class="d-lg-none">
                <img alt="Logo" src="{{asset('assets/media/logos/default-small.svg')}}" class=" theme-light-show h-35px" />
                <img alt="Logo" src="{{asset('assets/media/logos/default-small-dark.svg')}}" class="theme-dark-show h-35px" />
            </a>
        </div>
        <!--end::Mobile logo-->
                ...
                <div class="app-navbar-item ms-2 ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-35px symbol-md-40px"
                        ...
                        <div class="symbol symbol-50px me-5">
                            <img alt="Profile Picture" src="{{ $user->profile_photo ? Storage::url($user->profile_photo) : asset('assets/media/avatars/blank.png') }}" />
                        </div>
